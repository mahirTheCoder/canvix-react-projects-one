...
const SingleserviceContent = ({ icon , marketting, content }) => {
  return (
    <>
      <div className="w-[422px]   bg-[#F4F4F4] rounded-[20px]  hover:bg-secondary group duration-700 ">
        <button className="w-20 h-20 bg-secondary rounded-[50px] text-primary text-[25px] justify-center items-center flex mb-[62px] group-hover:bg-white m-[45px] ">{icon} </button>
