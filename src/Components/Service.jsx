...
const Service = () => {
  return (
    ...
    <div className="container mt-26 px-3 +">
      ...
      <div className='flex flex-wrap items-center gap:5 lg:gap-[66px] mt-[91px] pb-[9] '>
        ...
        <SingleserviceContent icon={<FaPencil className='group-hover:text-secondary'/>}   marketting={'Web Design'} content={'We specialize in creating visually stunning, user-friendly websites that align with your brand identity and deliver an exceptional.'} />
        <SingleserviceContent icon={<FaPencil className='group-hover:text-secondary'/>}   marketting={'IT Consulting'} content={'IT consulting, or information technology consulting, refers to the practice of providing advisory and implementation services'} />
        <SingleserviceContent icon={<FaPencil className='group-hover:text-secondary'/>}   marketting={'Brand Identity '} content={'It involves creating a unique and recognizable identity that sets the brand apart from competitors and resonates with the target audience.'} />
      </div>
    </div>
