    ...
    <>
      <div className="container mt-26 px-3 lg:px-0">
        <CommonHead
          ...
          service2={"High-impact services for your business"}
        />

        <div className="flex flex-wrap items-center gap:5 lg:gap-[120px] mt-[91px] pb-[93px] ">
          <SingleserviceContent
            icon={<FaPencil className="group-hover:text-secondary" />}
            marketting={"Content Marketing"}
            content={
              "Our team creates engaging and shareable content that resonates with your audience, drives organic traffic"
            }
          />
          <SingleserviceContent
            icon={<RiQuillPenAiFill className="group-hover:text-secondary" />}
            marketting={"Graphic Design "}
            content={
          ...
          <SingleserviceContent
            icon={
              <HiOutlineSpeakerphone className="group-hover:text-secondary" />
            }
            marketting={"Digital Marketing "}
            content={
              "Elevate your brands online presence with our data-driven digital marketing strategie From SEO and content marketing"
            }
          />
          <SingleserviceContent
            icon={<SiArtstation className="group-hover:text-secondary" />}
            marketting={"Web Design"}
            content={
          ...
          <SingleserviceContent
            icon={
              <RiContactsBook3Fill className="group-hover:text-secondary" />
            }
            marketting={"IT Consulting"}
            content={
          ...
          />
          <SingleserviceContent
            icon={<LiaGemSolid className="group-hover:text-secondary" />}
            marketting={"Brand Identity "}
            content={
